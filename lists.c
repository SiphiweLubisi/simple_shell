...
/**
 * add_node_end - adding the node to the end of the list
...
/**
 * print_list_str - printing only the str element of the list_t
...
/**
 * delete_node_at_index - deleting the node at given index
...
/**
 * free_list - to free all the nodes of the list
